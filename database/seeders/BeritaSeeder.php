    ...
    public function run()
    {
        DB::table('beritas')->insert([
            [
                ...
                'gambar' => public_path('storage\berita-images\cabai-bandung.jpg'),
                'tanggal' => '2024-06-03',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'gambar' => public_path('storage\berita-images\cabai-mahal.jpg'),
                'tanggal' => '2024-06-01',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'gambar' => public_path('storage\berita-images\panen-raya.jpg'),
                'tanggal' => '2024-05-25',
                'created_at' => now(),
                'updated_at' => now(),
            ],
