...
@section('content')
<div class="container">
    <h3 class="mb-4 text-center">Data Berita</h3>
    ...
    <div class="row align-items-center mb-3">
        ...
        <div class="col-md-9">
            <form method="GET" class="d-flex flex-wrap justify-content-start gap-2 ps-md-5">
                <input type="date" name="dari" value="{{ request('dari') }}" class="form-control" style="max-width: 160px;">
                <input type="date" name="sampai" value="{{ request('sampai') }}" class="form-control" style="max-width: 160px;">
                <input type="text" name="search" value="{{ request('search') }}" class="form-control" placeholder="Apa yang Kamu Cari" style="max-width: 200px;">
    ...
    {{-- Flash Message Cancel (di bawah filter) --}}
            ...
            <tbody>
                @forelse ($beritas as $no => $berita)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('berita.detail', $berita->id) }}" class="btn btn-info btn-sm">
